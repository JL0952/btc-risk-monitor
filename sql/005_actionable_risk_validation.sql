CREATE TABLE research.actionable_validation_runs (
...
CREATE TABLE research.actionable_risk_validation (
    validation_run_id UUID NOT NULL REFERENCES research.actionable_validation_runs(validation_run_id),
    ...
    FOREIGN KEY (publication_id,timestamp) REFERENCES online_isolation_forest_scores(publication_id,timestamp),
